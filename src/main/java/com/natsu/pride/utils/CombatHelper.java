...
public class CombatHelper {
	...
	/**
	 * Heavy weapons (axe, trident): balanced AROUND the attack delay (reduced damage if you swing
	 * too early), unlike the sword which needs to spam like in 1.8.9.
	 */
	...
	public static float getTotalDamage(Player player, Entity target, float baseDamage) {
		if (PrideFeature.REVERT_DAMAGE_LOGIC.enabled()) {
			...
			// getDamageBonus takes the target's EntityType (null if it's not a living entity).
