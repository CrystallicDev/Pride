...
public class ServerConfig {
	...
	public static final ModConfigSpec.BooleanValue DISABLE_SPEAR_ATTACK_COOLDOWN;
	...
	static {
		...
		DISABLE_SPEAR_ATTACK_COOLDOWN = builder
				.comment("Disable the attack cooldown for spears.")
				.define("disableSpearCooldown", true);
